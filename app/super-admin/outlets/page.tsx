...
import { 
  ...
  Building2, Loader2, CheckCircle2, XCircle, CreditCard, Calendar, Crown, Settings, Edit2, QrCode, ArrowRight, ShieldCheck, Clock, Key
} from "lucide-react";
...
export default function OutletsPage() {
  ...
  const [modalStep, setModalStep] = useState(1); // 1: Details, 2: QR, 3: UTR, 4: Success
  ...
  return (
    <div className="max-w-7xl mx-auto animate-in fade-in duration-300">
      ...
      {/* Main Table View (RESTORED ACTIONS AND CREDENTIALS) */}
                ...
                <tr key={outlet.id} className="hover:bg-slate-50 transition-colors">
                  ...
                  <td className="p-4">
                    <div className="flex flex-col items-start gap-1">
                      ...
                      {/* RESTORED: Email & Password Display below Tenant */}
                  ...
                  <td className="p-4 text-right">
                    {/* RESTORED: Actions Column and Edit Button */}
            ...
            <div className="p-6 overflow-y-auto custom-scrollbar">
              ...
              {modalStep === 1 && (
                <form onSubmit={handleProceedToPayment} className="space-y-4">
                  ...
                  {/* RESTORED/ENHANCED: Mandatory Email & Phone */}
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
